...
Next time, I'll be talking about how to create a [full-page image header][full-page-image-header] using some of the things you've learnt today (hint hint, think `vw` and `vh`).
